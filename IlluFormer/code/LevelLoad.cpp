...
Level::Level(std::string filepath)
	: objectAmount(0), isInitialized(false), index(levelAmount)
{
...
{
	isInitialized = true;
	objects.push_back(new DrawnObject(new UniformPosition{1, 1}, Coordinates::SnapToBgGrid(background.x, background.y),
	                                  16, Coordinates::GetGridIndices(), 6, background.texture, shader, objectAmount));
	objectAmount++;
	for (Sprite* sprite : sprites)
	{
		objects.push_back(new DrawnObject(new UniformPosition{sprite->x, sprite->y},
		                                  Coordinates::SnapToGrid(sprite->x, sprite->y), 16,
		                                  Coordinates::GetGridIndices(), 6, sprite->texture, shader, objectAmount));
...
void Menu::InitMenus(Shader* shader)
{
	...
	mainMenuObjects.push_back(new DrawnObject(new UniformPosition{1, 1}, Coordinates::SnapToBgGrid(16, 9), 16,
	                                          Coordinates::GetGridIndices(), 6, TextureList::textures[TEXTURE_BG_MENU],
	                                          shader, 0));
	mainMenuObjects.push_back(new DrawnObject(new UniformPosition{1, 1},
	                                          Coordinates::AddToCoords(positions, 0.0f, 0.0f), 16,
	                                          Coordinates::GetGridIndices(), 6,
	                                          TextureList::textures[TEXTURE_START_BUTTON], shader, 0));
	mainMenuObjects.push_back(new DrawnObject(new UniformPosition{1, 1},
	                                          Coordinates::AddToCoords(positions, 0.0f, 0.0f), 16,
	                                          Coordinates::GetGridIndices(), 6,
	                                          TextureList::textures[TEXTURE_START_BUTTON_HOVER], shader, 0));
	mainMenuObjects.push_back(new DrawnObject(new UniformPosition{1, 1},
	                                          Coordinates::AddToCoords(positions, 0.0f, -3.0f), 16,
	                                          Coordinates::GetGridIndices(), 6,
	                                          TextureList::textures[TEXTURE_EXIT_BUTTON], shader, 0));
	mainMenuObjects.push_back(new DrawnObject(new UniformPosition{1, 1},
	                                          Coordinates::AddToCoords(positions, 0.0f, -3.0f), 16,
	                                          Coordinates::GetGridIndices(), 6,
	                                          TextureList::textures[TEXTURE_EXIT_BUTTON_HOVER], shader, 0));

	pauseMenuObjects.push_back(new DrawnObject(new UniformPosition{1, 1}, Coordinates::SnapToBgGrid(16, 9), 16,
	                                           Coordinates::GetGridIndices(), 6,
	                                           TextureList::textures[TEXTURE_DARKEN_BG], shader, 0));
	pauseMenuObjects.push_back(new DrawnObject(new UniformPosition{1, 1},
	                                           Coordinates::AddToCoords(positions, 0.0f, 0.0f), 16,
	                                           Coordinates::GetGridIndices(), 6,
	                                           TextureList::textures[TEXTURE_RESTART_BUTTON], shader, 0));
	pauseMenuObjects.push_back(new DrawnObject(new UniformPosition{1, 1},
	                                           Coordinates::AddToCoords(positions, 0.0f, 0.0f), 16,
	                                           Coordinates::GetGridIndices(), 6,
	                                           TextureList::textures[TEXTURE_RESTART_BUTTON_HOVER], shader, 0));
	pauseMenuObjects.push_back(new DrawnObject(new UniformPosition{1, 1},
	                                           Coordinates::AddToCoords(positions, 0.0f, -3.0f), 16,
	                                           Coordinates::GetGridIndices(), 6,
	                                           TextureList::textures[TEXTURE_MENU_BUTTON], shader, 0));
	pauseMenuObjects.push_back(new DrawnObject(new UniformPosition{1, 1},
	                                           Coordinates::AddToCoords(positions, 0.0f, -3.0f), 16,
	                                           Coordinates::GetGridIndices(), 6,
	                                           TextureList::textures[TEXTURE_MENU_BUTTON_HOVER], shader, 0));

	endMenuObjects.push_back(new DrawnObject(new UniformPosition{1, 1}, Coordinates::SnapToBgGrid(16, 9), 16,
	                                         Coordinates::GetGridIndices(), 6, TextureList::textures[TEXTURE_DARKEN_BG],
	                                         shader, 0));
	endMenuObjects.push_back(new DrawnObject(new UniformPosition{1, 1},
	                                         Coordinates::AddToCoords(positions, 0.0f, -3.0f), 16,
	                                         Coordinates::GetGridIndices(), 6,
	                                         TextureList::textures[TEXTURE_MENU_BUTTON], shader, 0));
	endMenuObjects.push_back(new DrawnObject(new UniformPosition{1, 1},
	...
	endMenuObjects.push_back(new DrawnObject(new UniformPosition{1, 1}, positionsText, 16,
	                                         Coordinates::GetGridIndices(), 6, TextureList::textures[TEXTURE_TEXT_GJ],
	                                         shader, 0));
}
...
void Menu::ShowMainMenu(double cursorX, double cursorY)
{
	...
	if (cursorX > tempPosition[0] && cursorX < tempPosition[2] && cursorY < tempPosition[1] && cursorY > tempPosition[
		5])
